<h1 align="center">Keuch</h1>
<p align="center">
  <a href="https://keuchnotkush.github.io/Portfolio/">Portfolio</a> · <a href="https://linkedin.com/in/secfall">Linkedin</a>
</p>

<br>

```
SCOPE      Web · Windows / AD · Smart contracts · Humans · Unix · Secure Coding · Cloud & DevOps
POSTURE    Offensive first but Defensive enthusiast
AFFIL      EPITECH Paris · PoC Innovation
OPEN TO    Appsec · Security Research · Backend Development · OPS
```

<p align="center">
  <img src="https://skillicons.dev/icons?i=python,bash,c,rust,go,solidity,lua,ts,linux,docker,git&perline=11"/>
</p>
...
<p align="center"><sub>SCP-2521 ●●|●●●●●|●●|● — some things are better shown than written. Hence the portfolio.</sub></p>
